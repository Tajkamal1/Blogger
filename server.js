...
const getUserFullNameController = require('./src/controllers/auth/getUserFullName');
...
app.get('/api/getUserFullName/:email', getUserFullNameController.getUserFullName);
